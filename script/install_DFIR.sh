...
## Docker installation
echo "[*] Install docker"
export DEBIAN_FRONTEND=noninteractive;sudo -E bash -c 'sudo apt install -y apt-transport-https ca-certificates curl gnupg-agent software-properties-common lsb-release'
